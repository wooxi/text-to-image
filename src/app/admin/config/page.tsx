...
const configFields = [
  ...
  { key: "image_provider", label: "生图 Provider", placeholder: "openai_image" },
  ...
  { key: "image_model", label: "生图模型名称", placeholder: "gpt-image-1 / agnes-image-2.1-flash" },
  { key: "image_size", label: "默认图片尺寸", placeholder: "1024x1024" },
  { key: "video_provider", label: "视频 Provider", placeholder: "agnes_video" },
